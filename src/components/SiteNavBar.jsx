...
const SiteNavBar = () => {
    ...
    return (
        <div>
            ...
            <nav className='relative px-6 py-6 justify-between items-center bg-white flex'>
                ...
                <ul className='hidden absolute top-1/2 left-1/2 transform -tra/*  */nslate-y-1/2 -translate-x-1/2  lg:mx-auto lg:flex lg:items-center lg:w-auto lg:space-x-6'>
                    <li>
            ...
            <div className='hidden navbar-menu fixed top-0 left-0 bottom-0 w-5/6 max-w-sm z-50 '>
                <div onClick={() => { NavClick() }} className='navbar-backdrop  fixed inset-0 bg-gray-800 opacity-25 lg:hidden'/>
                <nav className='relative flex flex-col py-6 px-6 h-full w-full bg-white border-r overflow-y-auto lg:hidden'>
